    ...
    var pluginName = 'jsFlickrGallery', 
        defaults = {
            ...
            'setDefaultSize' : function() {
                this.thumbnailSize = this.imageSizes.medium_640;
        ...
        _createModal : function() {
            ...
            if ( !document.getElementById( this.options.modal.id ) ) {
                header = '<div class="' + GEN_HEADER_CONTAINER_CLASS + '">' +
                            '<button type="button" class="close-button" data-dismiss="modal" data-animation="false" aria-hidden="true">' +
                            '&times;</button>' +
                ...
                modal.className = 'modal jsfg-modal hide';
